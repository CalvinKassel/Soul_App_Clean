...
with_node \
  ...
  --target "/Users/calvinkassel/Desktop/SoulAI/SoulAppClean/ios/Pods/Target Support Files/Pods-SoulAppClean/ExpoModulesProvider.swift" \
  --entitlement "/Users/calvinkassel/Desktop/SoulAI/SoulAppClean/ios/SoulAppClean/SoulAppClean.entitlements" \
  --platform "apple" \
  --packages "expo" "expo-asset" "expo-blur" "expo-constants" "expo-dev-launcher" "expo-dev-menu" "expo-file-system" "expo-font" "expo-keep-awake" "expo-linear-gradient" "expo-localization"
